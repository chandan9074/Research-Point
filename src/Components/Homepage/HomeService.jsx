...
const HomeService = (props) => {
    ...
    return ( 
        <div className="py-10 px-10 home-service-card">
            ...
            <div>
                <h1 className="text-2xl text-gray-800 font-bold service-title" title={title}>{title}</h1>
                <h3 className="text-lg text-indigo-900 font-semibold"><i className="fas fa-calendar-alt"></i> {start_date}</h3>
                <h3 className="text-lg text-indigo-900 font-semibold"><i className="fas fa-clock"></i> {duration}</h3>
                <h3 className="text-lg text-indigo-900 font-semibold"><i className="fas fa-video"></i> {content_no}</h3>
                <h3 className="text-lg text-indigo-900 font-semibold"><i className="fas fa-users"></i> {enrolled}</h3>
